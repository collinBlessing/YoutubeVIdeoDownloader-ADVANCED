...
bar1 = awesometkinter.RadialProgressbar3d(
    frame_1, fg="green", parent_bg="#2a2d2e", size=(130, 130)
)
bar1.grid(row=0, column=0, pady=10, padx=20)

bar2 = awesometkinter.RadialProgressbar(
    frame_1, fg="red", parent_bg="#2a2d2e", size=(120, 120)
)
bar2.grid(row=0, column=1, pady=10, padx=20)

button_1 = customtkinter.CTkButton(
    frame_1, width=200, text="Start", command=button_function
)
